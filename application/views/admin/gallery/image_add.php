	...
	<div id="content">
		<form action="<?=base_url();?>admin/gallery/add_image/<?=$parent_id;?>" method="post" enctype="multipart/form-data">
			<table class="admin_module_form">
				...
				<tr><td class="admin_module_form_title">изображение</td><td><input type="file" name="image" size="255" />&nbsp;<strong>максимальный размер 800x800px не более 2Mb</strong></td></tr>
