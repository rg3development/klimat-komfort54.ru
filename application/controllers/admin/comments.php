...
class Comments extends Admin_Controller
{
    ...
    public function index() {
        $this->_data['comments']['approved'] = $this->comments->get_comments_list(1);
        $this->_data['comments']['unapproved'] = $this->comments->get_comments_list(0);
        $this->_view($this->_template, $this->_data);
    }
