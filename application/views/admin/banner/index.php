			...
			<div class="admin_module_list">
				<ul class="admin_list">
					...
					<li id="text<?=$banner->id;?>" onmouseover="$(this).children().children().css('color', '#0099cc')" onmouseout="$(this).children().children().css('color', '#666666')">
						...
						<a href="<?=base_url();?>admin/banner/edit/<?=$banner->id;?>/<?=$parent_id;?>" class="admin_form_action_page" title="редактировать"><img title="редактировать" alt="редактировать" src="<?=base_url();?>/img/admin/icon_edit_1.5.png"/></a>
						<div class="clear"></div>
					</li>
					<?php endforeach; ?>
					<?php endif; ?>
